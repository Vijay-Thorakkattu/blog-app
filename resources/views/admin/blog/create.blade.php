                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="blog_name" name="blog_name" placeholder="Enter the blog name"
                                value="{{ old('blog_name') }}" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" id="blog_date" name="blog_date" placeholder="Enter the blog Date"
                                value="{{ old('blog_date') }}" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="blog_author" name="blog_author" placeholder="Enter the author Name"
                                value="{{ old('blog_author') }}" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group" style="position: relative;">
                            ...
                            <button type="button" id="remove_image"
                                style="position: absolute; top: -5px; right: -5px; background: rgba(0, 0, 0, 0.5); color: white; border: none; border-radius: 50%; padding: 5px; font-size: 16px; display: none;">
                                ×
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea id="blog_content" name="blog_content" placeholder="Enter the Content" class="form-control">{{ old('blog_content') }}</textarea>
